...
public class LectureController {
    ...
    public String saveLecture(@ModelAttribute Lectures lectures,Model model) {
        ...
        lectureService.createPost(lectures);
        leId=lectures.getId();
